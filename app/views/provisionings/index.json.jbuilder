json.array!(@provisionings) do |provisioning|
  ...
  provisioning_wo_passwd.action = provisioning_wo_passwd.action.gsub(/(assw[^=]*=[ ]*)([^\r]*).*$/, '\1*******') unless provisioning_wo_passwd.action.nil?
  provisioning_wo_passwd.status = provisioning_wo_passwd.status.gsub(/(assw[^=]*=[ ]*)([^\r]*).*$/, '\1*******') unless provisioning_wo_passwd.status.nil?
